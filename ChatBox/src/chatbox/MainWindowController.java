...
public class MainWindowController implements Initializable {
    ...
    private void privateChatWindow(Socket socket, String target, MainWindowController mainCtrl) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/privateWindow.fxml"), ResourceBundle.getBundle("resources/fontawesome"));
                Stage stage = new Stage();
                try {
                    PrivateWindowController ctrl = new PrivateWindowController(mainCtrl , nickname, target);
